  ...
  return <Fragment>
    ...
    <div className="govuk-grid-row">
      <div className="govuk-grid-column-one-third">
        <Metric number={tasks.total} label="Tasks completed" />
      </div>
      <div className="govuk-grid-column-one-third">
        <Metric number={tasks.ppls} label="Project licences granted" />
      </div>
      <div className="govuk-grid-column-one-third">
        <Metric number={tasks.iterations / (tasks.ppls || 1)} label="Iterations of project applications" />
      </div>
    </div>
    <div className="govuk-grid-row">
      <div className="govuk-grid-column-full">

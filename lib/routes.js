...
module.exports = {
  ...
  establishment: {
    ...
    routes: {
      ...
      asruFees: {
        path: '/licence-fees/:year/personal',
        breadcrumb: false,
        router: licenceFeesAsruActions
      }
    }
  },
  profile: {

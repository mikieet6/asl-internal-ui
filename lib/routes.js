...
const projectUpdateIssueDate = require('../pages/project/update-issue-date');
...
module.exports = {
  ...
  projectUpdateIssueDate: {
    path: '/establishments/:establishmentId/projects/:projectId/update-issue-date',
    breadcrumb: false,
    router: projectUpdateIssueDate
  },
  project: {
